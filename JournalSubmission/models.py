...
class Submission(models.Model):
    ...
    reviewer1 = models.ForeignKey("auth.user", limit_choices_to={'groups__name':'Reviewer'},  on_delete=models.DO_NOTHING, related_name='reviewer_1')
    reviewer2 = models.ForeignKey("auth.user", limit_choices_to={'groups__name':'Reviewer'},  on_delete=models.DO_NOTHING, related_name='reviewer_2')
    reviewer3 = models.ForeignKey("auth.user", limit_choices_to={'groups__name':'Reviewer'},  on_delete=models.DO_NOTHING, related_name='reviewer_3')
